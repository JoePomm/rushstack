...
export class DeployAction extends BaseRushAction {
  ...
  protected onDefineParameters(): void {
    ...
    this._createArchive = this.defineStringParameter({
      ...
      description:
        'If specified, after the deployment is prepared, that target folder will be compressed into an archive' +
        ' with specified ARCHIVE_PATH. The file extension must be ".zip", but in the future other formats may be supported.'
    });
  }
